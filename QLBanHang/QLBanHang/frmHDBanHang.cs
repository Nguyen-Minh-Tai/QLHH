...
namespace QLBanHang
{
    public partial class frmHDBanHang : Form
    {
        ...
        {
            string sql;
            sql = "SELECT a.MaHang, b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia,a.ThanhTien FROM tblChiTietHoaDonBan AS a, " +
                "tblHang AS b WHERE a.MaHDBan = N'" + txtMaHDBan.Text + "' AND a.MaHang=b.MaHang";
        ...
        //Nạp tất cả giá trị control về ban đầu 
        ...
        private void btnLuuHD_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT MaHang FROM tblChiTietHoaDonBan WHERE MaHang=N'" + cboMaHang.SelectedValue + "' AND MaHDBan = N'" + txtMaHDBan.Text.Trim() + "'";
            if (Functions.CheckKey(sql))
            {
            ...
            sql = "INSERT INTO tblChiTietHoaDonBan(MaHDBan,MaHang,SoLuong,DonGia, GiamGia,ThanhTien) VALUES(N'" + txtMaHDBan.Text.Trim() + 
                "',N'" + cboMaHang.SelectedValue + "'," + txtSoLuong.Text +
        ...
        private void btnInHD_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia, a.ThanhTien " +
                  "FROM tblChiTietHoaDonBan AS a , tblHang AS b WHERE a.MaHDBan = N'" +
        ...
        private void btnXoaHD_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "SELECT MaHang,SoLuong FROM tblChiTietHoaDonBan WHERE MaHDBan = N'" + txtMaHDBan.Text + "'";
                ...
                sql = "DELETE tblChiTietHoaDonBan WHERE MaHDBan=N'" + txtMaHDBan.Text + "'";
                Functions.RunSQL(sql);
        ...
        private void dgvHDBanHang_DoubleClick(object sender, EventArgs e)
        {
            ...
            if ((MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes))
            {
                ...
                sql = "DELETE tblChiTietHoaDonBan WHERE MaHDBan=N'" + txtMaHDBan.Text + "' AND MaHang = N'" + MaHangxoa + "'";
                Functions.RunSQL(sql);
                // Cập nhật lại số lượng cho các mặt hàng
