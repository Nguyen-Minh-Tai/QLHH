...
namespace QLBanHang
{
    public partial class frmDMChatLieu : Form
    {
        ...
        {
            txtMaChatLieu.Enabled = false; // không cho nhập
        ...
        private void LoadDataGridView()
        {
            ...
            dgvChatLieu.Columns[0].HeaderText = "Mã chất liệu";//Thay đổi tên tiêu đề 
            dgvChatLieu.Columns[1].HeaderText = "Mã chất liệu";
            dgvChatLieu.Columns[0].Width = 100;//độ rộng của cột
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "Select MaChatLieu From tblChatLieu where MaChatLieu=N'" + txtMaChatLieu.Text.Trim() + "'"; // kiểm tra mã chất liệu đã tồn tại hay chưa 
            ...
            btnBoQua.Enabled = false;
            btnLuu.Enabled = false;
            txtMaChatLieu.Enabled = false;//ẩn 
        }

        private void btnSua_Click(object sender, EventArgs e)
        {
            string sql; //Lưu câu lệnh sql
            if (tblCL.Rows.Count == 0) // kiem tra có dữ liệu hay không 
            {
            ...
            sql = "UPDATE tblChatLieu SET TenChatLieu=N'" + txtTenChatLieu.Text.ToString() + "' WHERE MaChatLieu=N'" + txtMaChatLieu.Text + "'"; //Câu lệnh update
        ...
        private void txtMaChatLieu_KeyUp(object sender, KeyEventArgs e) //dùng enter thay cho tab
        {
