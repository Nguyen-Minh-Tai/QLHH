...
namespace QLBanHang.Class
{
    class Functions
    {
        ...
        public static void Conection()
        {
            ...
            if(con.State != ConnectionState.Open ) //kiểm tra trạng thái 
            {
                con.Open();//Mở kết nối
        ...
        //Phương thức thực thi câu lện select  lấy dữ liệu vào bảng
        public static DataTable GetDataToTable(string sql)
        {
            DataTable table = new DataTable(); //đối tượng để trả về 
            SqlDataAdapter dap = new SqlDataAdapter(sql,con);//Định nghĩa đối tượng thuộc lớp SqlDataAdapter
            dap.Fill(table);//lấy dữ liệu
            return table;
        }
        //Phương thức thực thi câu lệnh Insert, Update, Delete
        public static void RunSQL(string sql) //Hàm THực Hiện câu lệnh SQL
        {
        ...
        public static bool CheckKey(string sql)
        {
            ...
            DataTable table = new DataTable(); //datatable để chứa dữ liệu
            dap.Fill(table);//dữ lệu vào table
