...
namespace QLBanHang
{
    ...
    {
        private DataTable tblNV; // Lưu dữ liệu bản nhân viên
        ...
        private void LoadDataGridView()
        {
            ...
            dgvNhanVien.AllowUserToAddRows = false; //ngăng chặn thêm dong mới
        ...
        {
            string sql, gt;
            if (txtMaNhanVien.Text.Trim().Length == 0) //Kiểm Tra MNV
            {
            ...
            if (chkGioiTinh.Checked == true)
                ...
                gt = "Nữ";
            sql = "SELECT MaNhanVien FROM tblNhanVien WHERE MaNhanVien=N'" + txtMaNhanVien.Text.Trim() + "'";  // kiểm tra Mã nhân viên đã tồn tại hay chưa 
            ...
            //INSERT INTO tblTenBang (TenCot1,TenCot2) VALUES ('GiaTri1',GiaTri2)
            sql = "INSERT INTO tblNhanVien(MaNhanVien,TenNhanVien,GioiTinh, DiaChi,DienThoai, NgaySinh) VALUES (N'" + txtMaNhanVien.Text.Trim() + "',N'"
                + txtTenNhanVien.Text.Trim() + "',N'" + gt + "',N'" + txtDiaChi.Text.Trim() + "','" + mtbDienThoai.Text + "','" 
                + dtpNgaySinh.Value + "')";
        ...
        private void txtMaNhanVien_KeyUp_1(object sender, KeyEventArgs e)
        {
